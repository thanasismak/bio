...
export interface Translations {
  ...
  trustYearsSub: string
  trustPubLabel: string
  trustPubSub: string
  trustCourseLabel: string
  trustCourseSub: string
  ...
  expertiseS1Title: string
  expertiseS1Desc: string
  expertiseS2Title: string
  expertiseS2Desc: string
  expertiseS3Title: string
  expertiseS3Desc: string
  expertiseS4Title: string
  ...
  // Footer
  footerBio: string
  footerAccepting: string
  footerNavTitle: string
  footerServTitle: string
...
export const el: Translations = {
  ...
  heroScroll: 'Κύλιση',
  heroYearsExp: 'Χρόνια Εμπειρίας',
  heroFifa: 'Πιστοποιημένος FIFA',
  heroRating: 'Αξιολόγηση',

  // TrustMetrics
  trustYearsLabel: 'Χρόνια Άσκησης',
  trustYearsSub: 'Ορθοπαιδικής Χειρουργικής',
  trustPubLabel: 'Δημοσιεύσεις',
  trustPubSub: 'Επιστημονικά Περιοδικά',
  trustCourseLabel: 'Διεθνή Σεμινάρια',
  trustCourseSub: 'Εκπαιδεύσεις & Fellowships',
  trustRatingLabel: 'Αξιολόγηση Ασθενών',
  trustRatingSub: 'Βαθμολογία 5.0',
  ...
  expertiseHeading: 'Εξειδικευμένη φροντίδα σε κάθε πτυχή της ορθοπαιδικής υγείας',
  expertiseS1Title: 'Αθλητικές Κακώσεις',
  expertiseS1Desc:
    'Ολοκληρωμένη αντιμετώπιση μυοσκελετικών κακώσεων — από οξύ τραύμα έως χρόνιες παθήσεις — προσαρμοσμένη στους στόχους και τον τρόπο ζωής κάθε ασθενή.',
  ...
  // CallToAction
  ctaLabel: 'Ξεκινήστε',
  ctaHeading1: 'Έτοιμοι να ξεκινήσετε',
  ctaHeading2: 'το ταξίδι αποκατάστασής σας;',
  ctaBody:
    'Κάθε πρώτη επίσκεψη ξεκινά με πλήρη κλινική αξιολόγηση της κατάστασής σας — και καταλήγει σε ένα σαφές, εξατομικευμένο πλάνο δράσης. Νέοι και παλαιοί ασθενείς ευπρόσδεκτοι.',
  ctaSchedule: 'Κλείστε Ραντεβού',
  ctaLearn: 'Περισσότερες Πληροφορίες',
  ctaBullet1: 'Χωρίς παραπομπή',
  ctaBullet2: 'Διαθεσιμότητα εντός εβδομάδας',
  ctaBullet3: 'Δεκτοί ασθενείς ΕΟΠΥΥ & ιδιωτικής ασφάλισης',

  // Footer
  footerBio:
    'Ορθοπαιδικός Χειρουργός. Νοσοκομείο 401 ΓΣΝΑ. Ιδιωτικό ιατρείο στη Bioclinic Athens. Μέλος ESSKA & AO Foundation.',
  footerAccepting: 'Δεκτοί νέοι ασθενείς',
  footerNavTitle: 'Πλοήγηση',
  footerServTitle: 'Υπηρεσίες',
...
export const en: Translations = {
  ...
  heroScroll: 'Scroll',
  heroYearsExp: 'Years Experience',
  heroFifa: 'FIFA Certified',
  heroRating: 'Patient Rating',

  // TrustMetrics
  trustYearsLabel: 'Years of Practice',
  trustYearsSub: 'Orthopedic Surgery',
  trustPubLabel: 'Publications',
  trustPubSub: 'Peer-Reviewed Journals',
  trustCourseLabel: 'International Courses',
  trustCourseSub: 'Fellowships & Training',
  trustRatingLabel: 'Patient Rating',
  trustRatingSub: 'Out of 5.0 Stars',
  ...
  expertiseHeading: 'Specialised care for every dimension of orthopaedic health',
  expertiseS1Title: 'Sports Injuries',
  expertiseS1Desc:
    "Comprehensive management of musculoskeletal sports injuries — from acute trauma to chronic overuse conditions — tailored to each patient's activity level and goals.",
  ...
  ctaHeading1: 'Ready to begin your',
  ctaHeading2: 'recovery journey?',
  ctaBody:
    'A first consultation begins with a thorough clinical assessment of your condition — followed by a clear, personalised plan. New and returning patients welcome.',
  ctaSchedule: 'Schedule a Consultation',
  ctaLearn: 'Learn More',
  ctaBullet1: 'No referral required',
  ctaBullet2: 'Same-week appointments available',
  ctaBullet3: 'Private & ΕΟΠΥΥ patients welcome',

  // Footer
  footerBio:
    'Orthopedic Surgeon. Registrar at 401 ΓΣΝΑ. Private practice at Bioclinic Athens. ESSKA & AO Foundation member.',
  footerAccepting: 'Accepting new patients',
  footerNavTitle: 'Navigation',
  footerServTitle: 'Services',
